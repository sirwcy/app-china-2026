...
const COORDS_CIUDADES: Record<string, { lat: number; lng: number }> = {
  ...
  // Guangdong (faltantes)
  "汕尾":   { lat: 22.7789, lng: 115.3750 },
  "揭阳":   { lat: 23.5479, lng: 116.3729 },
  "河源":   { lat: 23.7430, lng: 114.6977 },
  "阳江":   { lat: 21.8581, lng: 111.9822 },
  "云浮":   { lat: 22.9280, lng: 112.0447 },
  "潮州":   { lat: 23.6567, lng: 116.6220 },

  // Guangxi
  "柳州":   { lat: 24.3264, lng: 109.4281 },
  "桂林":   { lat: 25.2741, lng: 110.2901 },
  "梧州":   { lat: 23.4793, lng: 111.2798 },

  // Hainan
  "三亚":   { lat: 18.2528, lng: 109.5121 },

  // Jiangsu (faltantes)
  "宿迁":   { lat: 33.9632, lng: 118.2751 },
  "徐州":   { lat: 34.2610, lng: 117.1857 },
  "连云港": { lat: 34.5966, lng: 119.2218 },
  "淮安":   { lat: 33.5502, lng: 119.0210 },
  "盐城":   { lat: 33.3491, lng: 120.1635 },
  "泰州":   { lat: 32.4574, lng: 119.9229 },
  "镇江":   { lat: 32.1878, lng: 119.4249 },
  "淮阴":   { lat: 33.5832, lng: 119.0340 },

  // Shandong (faltantes)
  "淄博":   { lat: 36.8131, lng: 118.0549 },
  "潍坊":   { lat: 36.7069, lng: 119.1619 },
  "烟台":   { lat: 37.4639, lng: 121.4479 },
  "威海":   { lat: 37.5138, lng: 122.1200 },
  "泰安":   { lat: 36.2004, lng: 117.0865 },
  "济宁":   { lat: 35.4150, lng: 116.5872 },
  "菏泽":   { lat: 35.2330, lng: 115.4804 },
  "临沂":   { lat: 35.0500, lng: 118.3400 },
  "聊城":   { lat: 36.4568, lng: 115.9855 },
  "德州":   { lat: 37.4361, lng: 116.3591 },
  "滨州":   { lat: 37.3839, lng: 117.9701 },
  "东营":   { lat: 37.4346, lng: 118.6749 },
  "日照":   { lat: 35.4164, lng: 119.5269 },
  "枣庄":   { lat: 34.8107, lng: 117.3219 },

  // Anhui (faltantes)
  "芜湖":   { lat: 31.3339, lng: 118.3713 },
  "蚌埠":   { lat: 32.9163, lng: 117.3898 },
  "淮南":   { lat: 32.6257, lng: 116.9994 },
  "马鞍山": { lat: 31.6704, lng: 118.5067 },
  "安庆":   { lat: 30.5430, lng: 117.0630 },
  "黄山":   { lat: 29.7147, lng: 118.3378 },
  "阜阳":   { lat: 32.8964, lng: 115.8192 },

  // Fujian (faltantes)
  "泉州":   { lat: 24.8742, lng: 118.6757 },
  "漳州":   { lat: 24.5140, lng: 117.6472 },
  "莆田":   { lat: 25.4541, lng: 119.0077 },
  "三明":   { lat: 26.2654, lng: 117.6386 },
  "南平":   { lat: 26.6430, lng: 118.1778 },
  "龙岩":   { lat: 25.0750, lng: 117.0169 },
  "宁德":   { lat: 26.6617, lng: 119.5479 },

  // Jiangxi (faltantes)
  "九江":   { lat: 29.7055, lng: 116.0017 },
  "景德镇": { lat: 29.2686, lng: 117.1785 },
  "萍乡":   { lat: 27.6226, lng: 113.8543 },
  "新余":   { lat: 27.8221, lng: 114.9271 },
  "鹰潭":   { lat: 28.2600, lng: 116.9354 },
  "赣州":   { lat: 25.8308, lng: 114.9330 },
  "吉安":   { lat: 27.1139, lng: 114.9927 },
  "抚州":   { lat: 27.9540, lng: 116.3583 },
  "上饶":   { lat: 28.4547, lng: 117.9433 },

  // Liaoning (faltantes)
  "大连":   { lat: 38.9140, lng: 121.6147 },
  "鞍山":   { lat: 41.1069, lng: 122.9951 },
  "抚顺":   { lat: 41.8618, lng: 123.9573 },
  "本溪":   { lat: 41.2938, lng: 123.7664 },
  "丹东":   { lat: 40.1293, lng: 124.3952 },
  "锦州":   { lat: 41.0954, lng: 121.1268 },
  "营口":   { lat: 40.6662, lng: 122.2355 },
  "阜新":   { lat: 42.0217, lng: 121.6682 },
  "辽阳":   { lat: 41.2694, lng: 123.1688 },
  "盘锦":   { lat: 41.1209, lng: 122.0706 },
  "铁岭":   { lat: 42.2996, lng: 123.8446 },

  // Jilin (faltantes)
  "吉林":   { lat: 43.8378, lng: 126.5497 },
  "延边":   { lat: 42.9064, lng: 129.5135 },
  "通化":   { lat: 41.7284, lng: 125.9398 },
  "白山":   { lat: 41.9411, lng: 126.4138 },
  "松原":   { lat: 45.1415, lng: 124.8246 },

  // Heilongjiang (faltantes)
  "齐齐哈尔": { lat: 47.3542, lng: 123.9183 },
  "大庆":   { lat: 46.5899, lng: 125.1032 },
  "鸡西":   { lat: 45.2951, lng: 130.9691 },
  "鹤岗":   { lat: 47.3495, lng: 130.2977 },
  "双鸭山": { lat: 46.6465, lng: 131.1538 },
  "佳木斯": { lat: 46.7996, lng: 130.3193 },
  "牡丹江": { lat: 44.5519, lng: 129.6330 },

  // Hebei (faltantes)
  "石家庄": { lat: 38.0428, lng: 114.5149 },
  "衡水":   { lat: 37.7356, lng: 115.6706 },
  "邢台":   { lat: 37.0700, lng: 114.4942 },
  "邯郸":   { lat: 36.6093, lng: 114.4923 },
  "沧州":   { lat: 38.3043, lng: 116.8388 },
  "唐山":   { lat: 39.6310, lng: 118.1800 },
  "廊坊":   { lat: 39.5382, lng: 116.6836 },
  "秦皇岛": { lat: 39.9355, lng: 119.5994 },
  "承德":   { lat: 40.9566, lng: 117.9633 },
  "保定":   { lat: 38.8749, lng: 115.4645 },
  "张家口": { lat: 40.8114, lng: 114.8794 },

  // Shanxi (faltantes)
  "太原":   { lat: 37.8736, lng: 112.5490 },
  "大同":   { lat: 40.0761, lng: 113.2997 },
  "晋中":   { lat: 37.6871, lng: 112.7523 },
  "阳泉":   { lat: 37.8561, lng: 113.5803 },
  "长治":   { lat: 36.1952, lng: 113.1163 },
  "临汾":   { lat: 36.0882, lng: 111.5188 },
  "晋城":   { lat: 35.4906, lng: 112.8516 },
  "吕梁":   { lat: 37.5190, lng: 111.1440 },

  // Inner Mongolia (faltantes)
  "呼和浩特": { lat: 40.8183, lng: 111.6557 },
  "包头":   { lat: 40.6557, lng: 109.8403 },
  "乌兰察布": { lat: 41.0340, lng: 113.1300 },
  "赤峰":   { lat: 42.2685, lng: 118.8886 },
  "通辽":   { lat: 43.6521, lng: 122.2440 },
  "呼伦贝尔": { lat: 49.2152, lng: 119.7659 },
  "鄂尔多斯": { lat: 39.6086, lng: 109.7812 },

  // Sichuan (faltantes)
  "绵阳":   { lat: 31.4678, lng: 104.6796 },
  "德阳":   { lat: 31.1273, lng: 104.3984 },
  "广元":   { lat: 32.4355, lng: 105.8440 },
  "遂宁":   { lat: 30.5330, lng: 105.5927 },
  "南充":   { lat: 30.8372, lng: 106.1100 },
  "达州":   { lat: 31.2095, lng: 107.5023 },
  "广安":   { lat: 30.4752, lng: 106.6333 },
  "自贡":   { lat: 29.3399, lng: 104.7783 },
  "攀枝花": { lat: 26.5823, lng: 101.7182 },
  "宜宾":   { lat: 28.7518, lng: 104.6428 },
  "眉山":   { lat: 30.0726, lng: 103.8487 },
  "乐山":   { lat: 29.5523, lng: 103.7661 },
  "雅安":   { lat: 29.9997, lng: 103.0010 },

  // Guizhou (faltantes)
  "遵义":   { lat: 27.7250, lng: 106.9278 },
  "铜仁":   { lat: 27.7185, lng: 109.1913 },
  "毕节":   { lat: 27.2834, lng: 105.3037 },
  "安顺":   { lat: 26.2453, lng: 105.8971 },

  // Yunnan (faltantes)
  "曲靖":   { lat: 25.4900, lng: 103.7959 },
  "玉溪":   { lat: 24.3580, lng: 102.5435 },
  "保山":   { lat: 25.1120, lng: 99.1620  },
  "昭通":   { lat: 27.3381, lng: 103.7171 },
  "丽江":   { lat: 26.8720, lng: 100.2330 },
  "普洱":   { lat: 22.8256, lng: 100.9665 },
  "西双版纳": { lat: 22.0071, lng: 100.7985 },
  "大理":   { lat: 25.6063, lng: 100.2677 },

  // Shaanxi (faltantes)
  "咸阳":   { lat: 34.3299, lng: 108.7100 },
  "铜川":   { lat: 34.8977, lng: 108.9448 },
  "宝鸡":   { lat: 34.3617, lng: 107.2378 },
  "渭南":   { lat: 34.5021, lng: 109.5093 },
  "延安":   { lat: 36.5853, lng: 109.4897 },
  "汉中":   { lat: 33.0686, lng: 107.0680 },
  "榆林":   { lat: 38.2851, lng: 109.7340 },
  "安康":   { lat: 32.6843, lng: 109.0293 },
  "商洛":   { lat: 33.8693, lng: 109.9399 },

  // Gansu (faltantes)
  "天水":   { lat: 34.5806, lng: 105.7244 },
  "平凉":   { lat: 35.5427, lng: 106.6654 },
  "庆阳":   { lat: 35.7342, lng: 107.6380 },
  "白银":   { lat: 36.5441, lng: 104.1385 },
  "定西":   { lat: 35.5785, lng: 104.6269 },
  "陇南":   { lat: 33.4004, lng: 104.9219 },
  "武威":   { lat: 37.9299, lng: 102.6384 },
  "张掖":   { lat: 38.9255, lng: 100.4494 },
  "嘉峪关": { lat: 39.7726, lng: 98.2890  },
  "酒泉":   { lat: 39.7320, lng: 98.4942  },

  // Ningxia (faltantes)
  "石嘴山": { lat: 39.0200, lng: 106.3768 },
  "吴忠":   { lat: 37.9971, lng: 106.1993 },
  "固原":   { lat: 36.0159, lng: 106.2425 },
  "中卫":   { lat: 37.4999, lng: 105.1965 },

  // Qinghai (faltantes)
  "海东":   { lat: 36.5025, lng: 102.4065 },

  // Xinjiang (faltantes)
  "克拉玛依": { lat: 45.5800, lng: 84.8892 },
  "吐鲁番": { lat: 42.9476, lng: 89.1843  },
  "哈密":   { lat: 42.8276, lng: 93.5143  },
  "喀什":   { lat: 39.4703, lng: 75.9898  },
  "和田":   { lat: 37.1144, lng: 79.9220  },
  "阿克苏": { lat: 41.1682, lng: 80.2600  },

  // Tibet (faltantes)
  "日喀则": { lat: 29.2672, lng: 88.8853  },
  "昌都":   { lat: 31.1403, lng: 97.1785  },
  "林芝":   { lat: 29.6475, lng: 94.3623  },

  // Henan (faltantes)
  "开封":   { lat: 34.7971, lng: 114.3067 },
  "洛阳":   { lat: 34.6197, lng: 112.4541 },
  "平顶山": { lat: 33.7660, lng: 113.3006 },
  "安阳":   { lat: 36.0980, lng: 114.3924 },
  "鹤壁":   { lat: 35.7484, lng: 114.2974 },
  "新乡":   { lat: 35.3023, lng: 113.9243 },
  "焦作":   { lat: 35.2397, lng: 113.2417 },
  "濮阳":   { lat: 35.7677, lng: 114.9989 },
  "许昌":   { lat: 34.0355, lng: 113.8522 },
  "漯河":   { lat: 33.5810, lng: 114.0169 },
  "三门峡": { lat: 34.7726, lng: 111.1951 },
  "南阳":   { lat: 32.9904, lng: 112.5280 },
  "信阳":   { lat: 32.1230, lng: 114.0750 },
  "周口":   { lat: 33.6258, lng: 114.6497 },
  "驻马店": { lat: 32.9803, lng: 114.0222 },

  // Hubei (faltantes)
  "黄石":   { lat: 30.2015, lng: 115.0448 },
  "宜昌":   { lat: 30.6917, lng: 111.2859 },
  "襄阳":   { lat: 32.0088, lng: 112.1224 },
  "鄂州":   { lat: 30.3917, lng: 114.8897 },
  "荆门":   { lat: 31.0354, lng: 112.2000 },
  "孝感":   { lat: 30.9218, lng: 113.9163 },
  "荆州":   { lat: 30.3350, lng: 112.2352 },
  "黄冈":   { lat: 30.4547, lng: 114.8779 },
  "咸宁":   { lat: 29.8528, lng: 114.3223 },
  "随州":   { lat: 31.6900, lng: 113.3824 },

  // Hunan (faltantes)
  "株洲":   { lat: 27.8274, lng: 113.1518 },
  "湘潭":   { lat: 27.8296, lng: 112.9447 },
  "衡阳":   { lat: 26.8938, lng: 112.5726 },
  "邵阳":   { lat: 27.2384, lng: 111.4677 },
  "岳阳":   { lat: 29.3571, lng: 113.1290 },
  "常德":   { lat: 29.0316, lng: 111.6984 },
  "张家界": { lat: 29.1170, lng: 110.4785 },
  "益阳":   { lat: 28.5548, lng: 112.3552 },
  "郴州":   { lat: 25.7981, lng: 113.0152 },
  "永州":   { lat: 26.4202, lng: 111.6146 },
  "怀化":   { lat: 27.5500, lng: 110.0019 },
  "湘西":   { lat: 28.3123, lng: 109.7394 },
};
